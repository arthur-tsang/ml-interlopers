...
for br in 10 20 30 50
do
    
    mname='bigkerUNet_hst_f32_k3'
    folder_postfix="_catval_exp10_c60_br${br}_nsub1_hst"
    in_size=80
    out_prefix='stdout'
    ...
    folder_postfix="_catval_exp10_c60_br${br}_nsub1_hstelt"
    in_size=320
    out_prefix='stdout'
    ...
    folder_postfix="_catval_exp10_c60_br${br}_nsub1_hstelt3"
    in_size=640
    out_prefix='stdout'
