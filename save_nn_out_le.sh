...
## start running on each resolution
mname='bigkerUNet_hst_f32_k3'
folder_postfix="_lecatval_exp10_c60_br20_nsub1_hst"
in_size=80
out_prefix='stdout'
...
folder_postfix="_lecatval_exp10_c60_br20_nsub1_hstelt"
in_size=320
out_prefix='stdout'
...
folder_postfix="_lecatval_exp10_c60_br20_nsub1_hstelt3"
in_size=640
out_prefix='stdout'
