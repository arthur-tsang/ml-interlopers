...
#SBATCH -t 2-0          # Runtime in D-HH:MM, minimum of 10 minutes (3-0)
#SBATCH -p dvorkin,sapphire,shared,serial_requeue  # Partition to submit to (shared)
...
echo "python gen_together.py $startidx $endidx catval --concentration 25"
python gen_together.py $startidx $endidx catval --concentration 25
echo "python gen_together.py $startidx $endidx catval --concentration 45"
python gen_together.py $startidx $endidx catval --concentration 45
