...
echo "python bl_bigkerunet.py _exp10_c25_br20_nsub1_hstelt 500000 $batchsize $SLURM_NTASKS 0.10 --pixnum 320 --fac 32 --ker 3"
python bl_bigkerunet.py _exp10_c25_br20_nsub1_hstelt 500000 $batchsize $SLURM_NTASKS 0.10 --pixnum 320 --fac 32 --ker 3
