...
echo "python gen_together.py $startidx $endidx cattrain --concentration 60 --numexposures 10"
python gen_together.py $startidx $endidx cattrain --concentration 60 --numexposures 10
