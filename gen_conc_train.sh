...
echo "python gen_together.py $startidx $endidx cattrain --concentration 25"
python gen_together.py $startidx $endidx cattrain --concentration 25
echo "python gen_together.py $startidx $endidx cattrain --concentration 45"
python gen_together.py $startidx $endidx cattrain --concentration 45
