...
#SBATCH --mem=250000           # Memory pool for all cores (see also --mem-per-cpu) (ran with 250k, but seff said we only used 12%)
...
echo "Batch size 16. Otherwise like best run."
echo "python bl_bigkerunet.py _sub_m8m11ninety_noise10_c60_hstelt3 500000 $batchsize $SLURM_NTASKS 0.10 --pixnum 640 --fac 32 --ker 3"
python bl_bigkerunet.py _sub_m8m11ninety_noise10_c60_hstelt3 500000 $batchsize $SLURM_NTASKS 0.10 --pixnum 640 --fac 32 --ker 3
