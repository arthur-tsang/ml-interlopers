...
echo "python gen_together.py $startidx $endidx cattrain --concentration 15 --numexposures 1 --skiphighres"
python gen_together.py $startidx $endidx cattrain --concentration 15 --numexposures 1 --skiphighres
