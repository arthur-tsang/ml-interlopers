...
def generate_set(seed, folder='multisubtest/'):
    """
    ...
    upper_mass = 10**10 / concentration_map[60][1]
    lower_mass = 10**8 / concentration_map[60][1]
    all_params = gen_image_general(seed, True, upper_mass, keyword,
                                   constraints={},
                                   mode='all params',
                                   cat_source=True,
                                   pixnum=640,
