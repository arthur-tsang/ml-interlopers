...
do
    ...
    folder_postfix="_catval_exp10_c60_br20_nsub${nsub}_hst"
    in_size=80
    out_prefix='stdout'
    ...
    folder_postfix="_catval_exp10_c60_br20_nsub${nsub}_hstelt"
    in_size=320
    out_prefix='stdout'
    ...
    folder_postfix="_catval_exp10_c60_br20_nsub${nsub}_hstelt3"
    in_size=640
    out_prefix='stdout'
