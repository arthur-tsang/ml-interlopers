...
#SBATCH -p gpu_test
#SBATCH --mem=5000           # Memory pool for all cores (see also --mem-per-cpu) (ran with 12k on higher resolution)
...
echo "python bl_bigkerunet.py _exp10_c45_br20_nsub1_hst 500000 $batchsize $SLURM_NTASKS 0.10 --pixnum 80 --fac 32 --ker 3"
python bl_bigkerunet.py _exp10_c45_br20_nsub1_hst 500000 $batchsize $SLURM_NTASKS 0.10 --pixnum 80 --fac 32 --ker 3
