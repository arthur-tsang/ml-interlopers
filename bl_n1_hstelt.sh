...
#SBATCH --mem=120000           # Memory pool for all cores (see also --mem-per-cpu) (ran with 250k, but seff said we only used 12%)
...
echo "python bl_bigkerunet.py _exp1_c15_br20_nsub1_hstelt 500000 $batchsize $SLURM_NTASKS 0.10 --pixnum 320 --fac 32 --ker 3"
python bl_bigkerunet.py _exp1_c15_br20_nsub1_hstelt 500000 $batchsize $SLURM_NTASKS 0.10 --pixnum 320 --fac 32 --ker 3
